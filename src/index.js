    ...
    res.send(`
        <html>
            ...
            <body>
                ...
                <script src="/js/bundle.js" data-token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IjYwYzAyZDM5LTkzYmEtNDU0Zi04ODEyLWMwNTNiNTk4Mjc1ZiIsIm5iZiI6MTc0MjkzMDEwNiwiZXhwIjoyNTM0MDIzMDA4MDAsImlhdCI6MTc0MjkzMDEwNn0.aJ61QUC31iwrVChLqN9se1P75fx1eQjMfJx_V7lH1Q4"
                ></script> <!-- Correct path -->
            </body>
        </html> 
    `);
